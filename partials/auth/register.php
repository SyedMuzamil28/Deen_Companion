...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
  ...
  if (strlen($pass) < 6) $msg = "Password must be at least 6 characters.";
  else {
...
<body class="bg-slate-900 text-white min-h-screen flex items-center justify-center p-6">
  <div class="w-full max-w-md bg-slate-800 rounded-2xl p-6 shadow">
    ...
    <?php if($msg): ?>
      <div class="bg-red-500/20 border border-red-500/30 rounded-xl p-3 text-sm mb-4"><?= htmlspecialchars($msg) ?></div>
    <?php endif; ?>
